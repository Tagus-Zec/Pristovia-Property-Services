<footer class="bg-navy text-white pt-24 pb-12 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
            <!-- Brand Column -->
            <div class="space-y-8">
                <a href="{{ request()->routeIs('home') ? '#home' : route('home').'#home' }}">
                    <img src="{{ asset('assets/img/logofoot.png') }}" alt="Pristovia Services Inc." class="h-16 w-auto ">
                </a>
            ...
            <!-- Operations Column -->
            <div class="space-y-8">
                <h4 class="text-primary font-black uppercase tracking-[0.2em] text-[10px]">{{ __('messages.services_title') }}</h4>
                <ul class="space-y-4 text-sm font-bold uppercase tracking-widest text-gray-500">
                    <li><a href="{{ route('service.post-construction') }}" class="hover:text-primary transition-colors">Post-Construction</a></li>
                    <li><a href="{{ route('service.commercial') }}" class="hover:text-primary transition-colors">Commercial Cleaning</a></li>
                    <li><a href="{{ route('service.pressure-washing') }}" class="hover:text-primary transition-colors">Pressure Washing & Exterior Restoration</a></li>
                    <li><a href="{{ route('service.property-maintenance') }}" class="hover:text-primary transition-colors">Property Maintenance</a></li>
                    <li><a href="{{ route('service.window-cleaning') }}" class="hover:text-primary transition-colors">Window Detailing</a></li>
                    <li><a href="{{ route('service.residential') }}" class="hover:text-primary transition-colors">Residential Cleaning</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-8">
                <h4 class="text-primary font-black uppercase tracking-[0.2em] text-[10px]">{{ __('messages.services_title') }}</h4>
                <ul class="space-y-4 text-sm font-bold uppercase tracking-widest text-gray-500">
                    <li> <a href="{{ request()->routeIs('home') ? '#home' : route('home').'#home' }}" class="hover:text-primary transition-colors">{{ __('messages.nav_home') }}</a></li>               
                    <li> <a href="{{ request()->routeIs('home') ? '#about' : route('home').'#about' }}" class="hover:text-primary transition-colors">{{ __('messages.nav_about') }}</a></li>
                    <li> <a href="{{ request()->routeIs('home') ? '#services' : route('home').'#services' }}" class="hover:text-primary transition-colors">{{ __('messages.nav_services') }}</a></li>
                    <li> <a href="{{ request()->routeIs('home') ? '#work' : route('home').'#work' }}" class="hover:text-primary transition-colors">{{ __('messages.nav_work') }}</a></li>
                </ul>
                 <div class="pt-4 border-t border-white/5">
                    <span class="text-[9px] font-black uppercase tracking-widest opacity-40 grayscale">{{ __('messages.footer_response_active') }}</span>
                </div>
            </div>

            <!-- Compliance & Contact -->
            <div class="space-y-8">
                <h4 class="text-primary font-black uppercase tracking-[0.2em] text-[10px]">{{ __('messages.footer_compliance_contact') }}</h4>
                <div class="space-y-6">
        ...
        <!-- GTA Coverage Column 
            <div class="space-y-8">
                <h4 class="text-primary font-black uppercase tracking-[0.2em] text-[10px]">{{ __('messages.footer_coverage') }}</h4>
                <div class="grid grid-cols-2 gap-4 text-[10px] font-black uppercase tracking-widest text-gray-500">
                    <div class="flex">
                        <span class="block hover:text-white transition-colors cursor-default">{{ __('messages.city_toronto') }} </span>
                        <span class="block hover:text-white transition-colors cursor-default">{{ __('messages.city_mississauga') }} </span>
                        <span class="block hover:text-white transition-colors cursor-default">{{ __('messages.city_vaughan') }} </span>
                        <span class="block hover:text-white transition-colors cursor-default">{{ __('messages.city_markham') }}</span>
                        <span class="block hover:text-white transition-colors cursor-default">{{ __('messages.city_brampton') }}</span>
                        <span class="block hover:text-white transition-colors cursor-default">{{ __('messages.city_oakville') }}</span>
                        <span class="block hover:text-white transition-colors cursor-default">{{ __('messages.city_richmond_hill') }}</span>
                        <span class="block hover:text-white transition-colors cursor-default">{{ __('messages.city_oshawa') }}</span>
                    </div>
                </div>-->
