<section class="py-20 bg-white dark:bg-navy border-t border-gray-100 dark:border-white/5">
    <div class="max-w-[1200px] mx-auto px-5">
        <div class="text-center mb-16 reveal">
            <h2 class="text-3xl md:text-5xl font-bold mb-4 dark:text-white font-montserrat">{{ __('messages.why_contractors_title') }}</h2>
            <p class="text-gray-500 dark:text-gray-400 max-w-[700px] mx-auto">{{ __('messages.why_contractors_subtitle') }}</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="reveal p-8 bg-gray-50 dark:bg-navy-light rounded-2xl border border-gray-100 dark:border-white/5 transition-all hover:shadow-xl group">
                ...
                <h3 class="text-xl font-bold mb-4 dark:text-white">{{ __('messages.reason_1_t') }}</h3>
                <p class="text-gray-500 dark:text-gray-400 leading-relaxed">{{ __('messages.reason_1_d') }}</p>
            </div>
            ...
            <div class="reveal p-8 bg-gray-50 dark:bg-navy-light rounded-2xl border border-gray-100 dark:border-white/5 transition-all hover:shadow-xl group" style="transition-delay: 0.1s">
                ...
                <h3 class="text-xl font-bold mb-4 dark:text-white">{{ __('messages.reason_2_t') }}</h3>
                <p class="text-gray-500 dark:text-gray-400 leading-relaxed">{{ __('messages.reason_2_d') }}</p>
            </div>
            ...
            <div class="reveal p-8 bg-gray-50 dark:bg-navy-light rounded-2xl border border-gray-100 dark:border-white/5 transition-all hover:shadow-xl group" style="transition-delay: 0.2s">
                ...
                <h3 class="text-xl font-bold mb-4 dark:text-white">{{ __('messages.reason_3_t') }}</h3>
                <p class="text-gray-500 dark:text-gray-400 leading-relaxed">{{ __('messages.reason_3_d') }}</p>
            </div>
        </div>
        ...
        <div class="mt-16 flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
            <div class="flex flex-col items-center gap-2">
                ...
                <span class="text-xs font-bold uppercase tracking-widest">{{ __('messages.stat_insurance_bonded') }}</span>
            </div>
            <div class="flex flex-col items-center gap-2">
                <i class="fas fa-user-shield fa-3x text-navy dark:text-white"></i>
                <span class="text-xs font-bold uppercase tracking-widest">{{ __('messages.stat_wsib_compliant') }}</span>
            </div>
            {{-- Add more badges here if available --}}
        </div>
    </div>
</section>
