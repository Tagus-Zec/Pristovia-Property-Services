<section id="services" class="py-24 bg-neutral-light dark:bg-navy relative">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
            ...
            <!-- Commercial -->
            <a href="{{ route('service.commercial') }}" class="service-card group">
                <div class="relative h-64 -mx-10 -mt-10 mb-8 overflow-hidden">
                    <img src="{{ asset('assets/img/im6.jpg') }}" alt="Commercial Cleaning" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-navy/40 group-hover:bg-navy/20"></div>
                </div>
                <h4 class="text-2xl font-black text-navy dark:text-white mb-4 uppercase tracking-tight">{{ __('messages.service_commercial') }}</h4>
            ...
            <!-- Post-Construction -->
            <a href="{{ route('service.post-construction') }}" class="service-card group">
                <div class="relative h-64 -mx-10 -mt-10 mb-8 overflow-hidden">
                    <img src="{{ asset('assets/img/img1.jpg') }}" alt="Post-Construction" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-navy/40 group-hover:bg-navy/20"></div>
                ...
                <h4 class="text-2xl font-black text-navy dark:text-white mb-4 uppercase tracking-tight">{{ __('messages.service_post_con') }}</h4>
            ...
            <a href="{{ route('service.property-maintenance') }}" class="service-card group">
                <div class="relative h-64 -mx-10 -mt-10 mb-8 overflow-hidden">
                    <img src="{{ asset('assets/img/img10 (44).jpg') }}" alt="Asset Maintenance" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-navy/40 group-hover:bg-navy/20"></div>
                </div>
                <h4 class="text-2xl font-black text-navy dark:text-white mb-4 uppercase tracking-tight">{{ __('messages.service_hardscape') }}</h4>
            ...
            <!-- pressure-washing -->
            <a href="{{ route('service.pressure-washing') }}" class="service-card group">
                <div class="relative h-64 -mx-10 -mt-10 mb-8 overflow-hidden">
                    <img src="{{ asset('assets/img/im3.jpg') }}" alt="Commercial Cleaning" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-navy/40 group-hover:bg-navy/20"></div>
                </div>
            ...
            <!-- window-cleaning -->
            <a href="{{ route('service.window-cleaning') }}" class="service-card group">
                <div class="relative h-64 -mx-10 -mt-10 mb-8 overflow-hidden">
                    <img src="{{ asset('assets/img/img40.png') }}" alt="Post-Construction" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-navy/40 group-hover:bg-navy/20"></div>
                </div>
            ...
            <a href="{{ route('service.residential') }}" class="service-card group">
                <div class="relative h-64 -mx-10 -mt-10 mb-8 overflow-hidden">
                    <img src="{{ asset('assets/img/img3.jpg') }}" alt="Asset Maintenance" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    <div class="absolute inset-0 bg-navy/40 group-hover:bg-navy/20"></div>
                </div>
