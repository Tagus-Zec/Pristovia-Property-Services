    ...
    <div class="max-w-[1200px] mx-auto px-5">
        <div class="text-center mb-16 reveal">
            ...
            <p class="mt-6 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                {{ __('messages.locations_subtitle') }}
            </p>
        </div>
        ...
        <div class="mt-16 p-8 glass-card rounded-3xl border-l-8 border-gold reveal">
            <div class="flex flex-col md:flex-row items-center gap-8">
                <div class="flex-1">
                    <h3 class="text-2xl font-bold mb-4 font-montserrat">{{ __('messages.coverage_area_title') }}</h3>
                    <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                        {{ __('messages.coverage_area_text') }}
                    </p>
                ...
                <div class="w-full md:w-1/3">
                    <a href="#quote" class="btn btn-primary w-full">{{ __('messages.cta_quote') }}</a>
                </div>
            </div>
        </div>
    </div>
