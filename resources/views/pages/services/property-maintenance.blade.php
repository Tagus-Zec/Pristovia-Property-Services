...
@section('title', 'Property Maintenance & Hardscape GTA | Pristovia')
@section('description', 'Comprehensive property maintenance and hardscape restoration in Toronto. We keep your commercial assets in peak condition.')

@section('content')
<section class="relative py-40 bg-navy text-white overflow-hidden">
    <div class="absolute inset-0 opacity-20">
        <img src="{{ asset('assets/img/img10 (17).jpg') }}" alt="Hardscape Maintenance" class="w-full h-full object-cover scale-110">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div class="rounded-[50px] overflow-hidden shadow-3xl border-8 border-navy-light/5">
                <img src="{{ asset('assets/img/img10 (35).jpg') }}" alt="Hardscape Detail" class="w-full h-auto">
            </div>
        </div>
    </div>
</section>
