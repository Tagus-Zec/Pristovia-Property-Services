...
@section('title', 'Residential Cleaning Services GTA | Pristovia')
@section('description', 'Premium residential cleaning services in Toronto, Mississauga, Vaughan and GTA. Reliable, detailed and trusted home cleaning solutions.')
...
<section class="relative py-40 bg-navy text-white overflow-hidden">
    <div class="absolute inset-0 opacity-20">
        <img 
            src="{{ asset('assets/img/img10 (14).jpg') }}" class="w-full h-full object-cover scale-110 animate-pulse-slow" 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div class="relative">
                ...
                <div class="rounded-[50px] overflow-hidden shadow-3xl border-8 border-navy-light/5">
                    <img 
                        src="{{ asset('assets/img/img10 (13).jpg') }}" 
