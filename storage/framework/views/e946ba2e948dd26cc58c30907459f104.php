<?php $__env->startSection('title', 'Commercial Cleaning Services Toronto & GTA | Pristovia'); ?>
<?php $__env->startSection('description', 'Premium commercial janitorial services for offices, retail spaces, and corporate facilities across the Greater Toronto Area.'); ?>

<?php $__env->startSection('content'); ?>
<section class="relative py-40 bg-navy text-white overflow-hidden">
    <div class="absolute inset-0 opacity-20">
        <img src="<?php echo e(asset('assets/img/img10 (28).jpg')); ?>" alt="Commercial Cleaning" class="w-full h-full object-cover scale-110">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div class="rounded-[50px] overflow-hidden shadow-3xl order-2 lg:order-1 border-8 border-navy-light/5">
                <img src="<?php echo e(asset('assets/img/im4.jpg')); ?>" alt="Office Cleaning" class="w-full h-auto">
            </div>
            <div class="space-y-10 order-1 lg:order-2">
                ...
                <p class="text-lg text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                    <?php echo e(__('messages.long_commercial')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pristovia_property\resources\views/pages/services/commercial.blade.php ENDPATH**/ ?>