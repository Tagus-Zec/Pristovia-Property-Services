<?php $__env->startSection('title', 'Professional Pressure Washing GTA | Pristovia'); ?>
<?php $__env->startSection('description', 'High-performance exterior pressure washing for commercial and residential properties in Toronto. Restore your property\'s curb appeal.'); ?>

<?php $__env->startSection('content'); ?>
<section class="relative py-40 bg-navy text-white overflow-hidden">
    <div class="absolute inset-0 opacity-20">
        <img src="<?php echo e(asset('assets/img/img1.jpg')); ?>" alt="Pressure Washing" class="w-full h-full object-cover scale-110">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div class="text-center max-w-4xl mx-auto mb-24">
            ...
            <p class="text-lg text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                <?php echo e(__('messages.long_pressure_washing')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pristovia_property\resources\views/pages/services/pressure-washing.blade.php ENDPATH**/ ?>