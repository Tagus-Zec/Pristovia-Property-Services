...
>
    ...
    <!-- AFTER IMAGE -->
    <img src="<?php echo e(asset('assets/img/img10 (6).jpg')); ?>"
         class="absolute inset-0 w-full h-full object-cover z-0">

    <!-- BEFORE IMAGE -->
    <img src="<?php echo e(asset('assets/img/img10 (5).jpg')); ?>"
    ...
    <div class="absolute bottom-10 left-10 z-40 glass-card px-6 py-3 rounded-full text-[10px] font-black uppercase tracking-widest text-primary border border-primary/30 backdrop-blur-md">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6" x-data="galleryModule()">
            <?php if(isset($gallery_images)): ?>
                <?php $__currentLoopData = $gallery_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="group relative aspect-[4/5] overflow-hidden rounded-[32px] cursor-pointer reveal active" 
                         x-show="(activeCategory === 'all' || activeCategory === '<?php echo e($cat); ?>') && <?php echo e($index); ?> < limit"
                         x-transition:enter="transition ease-out duration-500"
                         x-transition:enter-start="opacity-0 scale-90"
                         x-transition:enter-end="opacity-100 scale-100"
                         style="transition-delay: <?php echo e(($index % 4) * 100); ?>ms"
                         @click="openLightbox('<?php echo e(addslashes(asset($image))); ?>')">
                        <img src="<?php echo e(asset($image)); ?>" alt="Pristovia Operation" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" loading="lazy">
                        <div class="absolute inset-0 bg-gradient-to-t from-navy via-navy/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-8">
                            ...
                            <h5 class="text-white font-bold uppercase tracking-widest text-[9px] mb-1">GTA Division: <?php echo e(ucfirst($cat)); ?></h5>
            ...
            <div class="col-span-2 md:col-span-3 lg:col-span-4 mt-16 text-center">
                 <button x-show="limit < <?php echo e(count($gallery_images ?? [])); ?>" @click="loadMore()" class="btn btn-outline" style="border: goldenrod 2px solid;">Load More Projects</button>
...
</script><?php /**PATH C:\xampp\htdocs\pristovia_property\resources\views/partials/sections/work.blade.php ENDPATH**/ ?>