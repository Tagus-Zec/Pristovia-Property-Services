...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', __('messages.meta_title')); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', __('messages.meta_desc')); ?>">
    ...
    <script>
        ...
        window.translations = <?php echo json_encode(__('messages')); ?>;
    </script>
...
<?php /**PATH C:\xampp\htdocs\pristovia_property\resources\views/layouts/app.blade.php ENDPATH**/ ?>