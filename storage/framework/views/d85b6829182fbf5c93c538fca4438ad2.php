<?php $__env->startSection('title', 'Professional Window Cleaning GTA | Pristovia'); ?>
<?php $__env->startSection('description', 'Crystal clear window cleaning for commercial and residential properties in Toronto, Mississauga, and Vaughan. Interior and exterior detailing.'); ?>

<?php $__env->startSection('content'); ?>
<section class="relative py-40 bg-navy text-white overflow-hidden">
    <div class="absolute inset-0 opacity-20">
        <img src="<?php echo e(asset('assets/img/img20.jpg')); ?>" alt="Window Cleaning" class="w-full h-full object-cover scale-110">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div class="rounded-[50px] overflow-hidden shadow-2xl order-1 lg:order-1 border-8 border-navy-light/5">
                <img src="<?php echo e(asset('assets/img/img10 (9).jpg')); ?>" alt="Office Cleaning" class="w-full h-auto">
            </div>
            ...
            <p class="text-lg text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                <?php echo e(__('messages.long_window')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pristovia_property\resources\views/pages/services/window-cleaning.blade.php ENDPATH**/ ?>