<section id="faq" class="py-24 bg-white dark:bg-navy transition-colors duration-500">
    <div class="max-w-[1200px] mx-auto px-5">
        <div class="text-center mb-16 reveal">
            <h2 class="text-4xl font-bold font-montserrat relative pb-4 after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-20 after:h-1 after:bg-primary after:rounded-full text-navy dark:text-white"><?php echo e(__('messages.faq_title')); ?></h2>
        </div>
        <div class="max-w-[800px] mx-auto reveal" x-data="{ activeFaq: 1 }">
            <div class="border-b border-navy/10 dark:border-white/10">
                ...
                >
                    <?php echo e(__('messages.faq_1_q')); ?> 
                ...
                <div 
                    ...
                    x-collapse
                >
                    <p class="pb-6 text-navy/60 dark:text-white/60"><?php echo e(__('messages.faq_1_a')); ?></p>
                </div>
            </div>
            <div class="border-b border-navy/10 dark:border-white/10">
                <button 
                    ...
                    class="w-full py-6 flex justify-between items-center text-xl font-bold text-left font-montserrat text-navy dark:text-white hover:text-primary transition-colors"
                >
                    <?php echo e(__('messages.faq_2_q')); ?> 
                ...
                <div 
                    ...
                    x-collapse
                >
                    <p class="pb-6 text-navy/60 dark:text-white/60"><?php echo e(__('messages.faq_2_a')); ?></p>
                </div>
            </div>
            <div class="border-b border-navy/10 dark:border-white/10">
                <button 
                    ...
                    class="w-full py-6 flex justify-between items-center text-xl font-bold text-left font-montserrat text-navy dark:text-white hover:text-primary transition-colors"
                >
                    <?php echo e(__('messages.faq_3_q')); ?> 
                ...
                <div 
                    ...
                    x-collapse
                >
                    <p class="pb-6 text-navy/60 dark:text-white/60"><?php echo e(__('messages.faq_3_a')); ?></p>
                </div>
            </div>
            <div class="border-b border-navy/10 dark:border-white/10">
                <button 
                    ...
                    class="w-full py-6 flex justify-between items-center text-xl font-bold text-left font-montserrat text-navy dark:text-white hover:text-primary transition-colors"
                >
                    <?php echo e(__('messages.faq_4_q')); ?> 
                ...
                <div 
                    ...
                    x-collapse
                >
                    <p class="pb-6 text-navy/60 dark:text-white/60"><?php echo e(__('messages.faq_4_a')); ?></p>
                </div>
            </div>
        </div>
    </div>
</section><?php /**PATH C:\xampp\htdocs\pristovia_property\resources\views/partials/sections/faq.blade.php ENDPATH**/ ?>