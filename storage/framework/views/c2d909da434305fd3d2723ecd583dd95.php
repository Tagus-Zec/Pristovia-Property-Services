<?php $__env->startSection('title', 'Post-Construction Cleaning Services GTA | Pristovia'); ?>
<?php $__env->startSection('description', 'Expert post-construction cleaning for new developments and renovations in Toronto, Mississauga, and Vaughan. Ready-for-occupancy results.'); ?>

<?php $__env->startSection('content'); ?>
<section class="relative py-40 bg-navy text-white overflow-hidden">
    <div class="absolute inset-0 opacity-20">
        <img src="<?php echo e(asset('assets/img/img1.jpg')); ?>" alt="Post Construction" class="w-full h-full object-cover scale-110 animate-pulse-slow">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div class="space-y-10">
                ...
                <p class="text-lg text-gray-500 dark:text-gray-400 leading-relaxed font-medium">
                    <?php echo e(__('messages.long_post_con')); ?>
            ...
            <div class="relative">
                <div class="rounded-[50px] overflow-hidden shadow-3xl border-8 border-navy-light/5">
                    <img src="<?php echo e(asset('assets/img/img1.jpg')); ?>" alt="Post Con Detail" class="w-full h-auto">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pristovia_property\resources\views/pages/services/post-construction.blade.php ENDPATH**/ ?>